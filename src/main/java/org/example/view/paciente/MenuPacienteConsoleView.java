...
public class MenuPacienteConsoleView implements IMenuPacienteView {
    ...
    public int mostrarMenuPrincipal(String nome) {
        ...
        System.out.println(Ferramentas.GREENclaro+"─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────");
        System.out.println(Ferramentas.RESET+" (1) "+ Ferramentas.GREEN+"➔"+ Ferramentas.RESET+" Ver minhas consultas                                                                                                                          ");
        System.out.println(Ferramentas.RESET+" (2) "+ Ferramentas.GREEN+"➔"+ Ferramentas.RESET+" Agendar nova consulta                                                                                                                         ");
        System.out.println(Ferramentas.RESET+" (3) "+ Ferramentas.GREEN+"➔"+ Ferramentas.RESET+" Cancelar Consulta                                                                                                                             ");
        System.out.println(Ferramentas.RESET+" (4) "+ Ferramentas.GREEN+"➔"+ Ferramentas.RESET+" Ver historico completo                                                                                                                        ");
        System.out.println(Ferramentas.RESET+" (5) "+ Ferramentas.GREEN+"➔"+ Ferramentas.RESET+" Meu prontuario");
        System.out.println(Ferramentas.RESET+" (6) "+ Ferramentas.GREEN+"➔"+ Ferramentas.RESET+" Visualizar meu perfil");
        System.out.println(Ferramentas.RESET+" (7) "+ Ferramentas.GREEN+"➔"+ Ferramentas.RESET+" Buscar medico por especialidade");
        System.out.println(Ferramentas.RESET+" (8) "+ Ferramentas.GREEN+"➔"+ Ferramentas.RESET+" Editar meu perfil");
        System.out.println(Ferramentas.RESET+" (9) "+ Ferramentas.GREEN+"➔"+ Ferramentas.RESET+" Ver mapa                                                                                                                                      ");
        System.out.println(Ferramentas.RESET+" (0) "+ Ferramentas.GREEN+"➔"+ Ferramentas.RESET+" Voltar para menu principal                                                                                                                                      ");
        System.out.println(Ferramentas.GREENclaro+"─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────");
